...
?>
<script>
/*Mover essa rotina abaixo para utils ou webmail*/
$(function(){
    $("#labelBox").html($("input:hidden[name=mailbox]").val() +
        '<img onclick=loadListMails($("#alignWebmail").val(),$("input:hidden[name=mailbox]").val(),0),verifyUnread() class="iconLoad" src="../images/reload.png">');

});
$('input[name=markUnread]').click(
    function(){
        msg = new Array();        
...
echo "<input  type='hidden' name='show_num' value='$show_num'>";
echo '</body></html>';
