...
?>
<div class="topLogin2">
    <div class="messageLogin2">
        <img src="../images/mini_mail.png"><span><?php echo _('Welcome to Emexis-Webmail');?></span>
    </div>    
</div>
<center style="height:100%;background-color:#f5f6f7;">
    <div class="screenLogin2">
        <div>            
            <table style="padding-left:130px;padding-top: 280px;">
                <tr> 
                    <td><?php echo _('Name');?></td>
                    <td><?php echo addInput($username_form_name, $loginname_value, 0, 0, 'class="mailInput" onfocus="alreadyFocused=true;"');?></td>
                </tr>
                <tr>
