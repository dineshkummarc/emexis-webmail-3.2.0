...
function cachePrefValues($data_dir, $username) {
    ...
    if (!file_exists($filename)) {
        ...
        echo msgErrorPage(sprintf( _("Preference file, %s, does not exist. Log out, and log back in to create a default preference file."), $filename));        
        exit;
    }
    ...
    {
        include_once( SM_PATH . 'functions/utils.php' );
        echo msgErrorPage(sprintf( _("Preference file, %s, could not be opened. Contact your system administrator to resolve this issue."), $filename));        
        exit;
    }
