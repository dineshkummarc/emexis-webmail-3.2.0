...
function load_optpage_data_display() {
    ...
    $optvals[SMOPT_GRP_GENERAL][] = array(
        'name'    => 'load_listmail',
        'caption' => _("Load mailing list to start"),
        'type'    => SMOPT_TYPE_BOOLEAN,
        'refresh' => SMOPT_REFRESH_ALL,
        'posvals' => $load_listmail
    );
...
/*    $optvals[SMOPT_GRP_GENERAL][] = array(
    ...
    $optvals[SMOPT_GRP_MESSAGE][] = array(
        'name'    => 'msg_with_checkbox',
        'caption' => _("Select messages using checkbox"),
        'type'    => SMOPT_TYPE_BOOLEAN,
        'posvals' => $msg_with_checkbox
    );
	/*
	...
	*/
	...
	$optvals[SMOPT_GRP_MESSAGE][] = array(
		'name'    => 'layout',
        'caption' => _("Select webmail's layout"),
      	'type' => SMOPT_TYPE_STRLIST, 
		'posvals' => array('vertical' => 'Vertical',
