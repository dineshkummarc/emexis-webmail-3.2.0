...
function load_optpage_data_personal() {
    ...
    $full_name = utf8_decode(getPref($data_dir, $username, 'full_name'));
    $reply_to = getPref($data_dir, $username, 'reply_to');
    $email_address  = getPref($data_dir, $username, 'email_address');
    $signature  = utf8_decode(getSig($data_dir, $username, 'g'));
    ...
    if ($edit_identity) {
        $identities_link_value = '<a href="javascript:showDialogIdentities()">'
